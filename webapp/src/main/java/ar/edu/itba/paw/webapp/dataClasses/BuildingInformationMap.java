...
public class BuildingInformationMap {
    ...
    private BuildingInformationMap(){
        ...
        infoList.add(new InformationBuilding(3,"barraks", "Este tipo de edificio te ayuda a defenderte de los ataques enemigos"));
        ...
        infoList.add(new InformationBuilding(5,"mill", "Este tipo de edificio es un molino y se utiliza para obtener comida."));
        infoList.add(new InformationBuilding(6,"blacksmith", "Este tipo de edificio para mejorar a las tropas"));
    }
