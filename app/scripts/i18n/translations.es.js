...
define([], function() {
  ...
  return {
    ...
    SIZE: 'El campo debería tener entre {2} y {1} caracteres',
    LOGIN: 'Inicia Sesión',
    ...
    PASSWORD_DONT_MATCH: 'Las contraseñas no son iguales',
    ...
    DESC_BARRACKS : 'TEste edificio es un cuartel. Aquí se pueden entrenar guerreros.',
