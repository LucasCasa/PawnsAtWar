...
define([], function() {
  ...
  return {
    ...
    ALERT_SPLIT: 'Separando ejército hacia {{x}},{{y}}',
    ALERT_MOVE: 'Moviendo hacia {{x}},{{y}}',
    ALERT_MERGE: 'Juntando ejércitos en {{x}},{{y}}',
    ALERT_ATTACK_NOTIFICATION: 'Te están atacando en {{x}},{{y}}',
    ALERT_RETURN: 'Tus tropas están volviendo de {{x}}, {{y}}',
    ENDS_IN: 'Finaliza en',
    SECONDS: 'segundos',
    UPGRADE: 'Mejorando',
    RECRUIT: 'Entrenando',
    GAME_OVER: 'Su castillo fue destruido.',
    ARMY_BUSY: 'Ejército Ocupado',
    ...
    DESC_CASTLE : 'Este edificio es un castillo. Aumentarlo de nivel permite almacenar más recursos. Si un jugador se queda sin castillos pierde.',
